...
export const style = scoped.css`
  ...
  .top-site-tiles-mask {
    ...
    max-width: var(--self-max-grid-width);
  ...
  &.collapsed .top-site-tiles-mask {
    --self-max-grid-width: calc(${collapsedTileCount} * var(--self-tile-width));

    overflow-x: hidden;
    max-height: var(--self-tile-height);
  }
