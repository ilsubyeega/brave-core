...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Pin shortcut page
      ...
      {"braveOriginNtpAdsToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_NTP_ADS_TOGGLE_TITLE},
      {"braveOriginRewardsToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_REWARDS_TOGGLE_TITLE},
      {"braveOriginSearchAdsToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_SEARCH_ADS_TOGGLE_TITLE},
      {"braveOriginSectionFeaturesTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_FEATURES_SECTION_TITLE},
      {"braveOriginEmailAliasToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_EMAIL_ALIAS_TOGGLE_TITLE},
      ...
      {"braveOriginP3ACrashReportToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_P3A_CRASH_REPORT_TOGGLE_TITLE},
      {"braveOriginSidebarToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_SIDEBAR_TOGGLE_TITLE},
      ...
      {"braveOriginWeb3DomainsToggleTitle",
       IDS_SETTINGS_BRAVE_ORIGIN_WEB3_TOGGLE_TITLE},
