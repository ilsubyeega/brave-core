...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  // Search settings
      ...
      // Leo Customization
      {"braveLeoAssistantCustomizationTitle", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_TITLE},
      {"braveLeoAssistantCustomizationDescription", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_DESCRIPTION},
      {"braveLeoAssistantCustomizationPageTitle", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_PAGE_TITLE},
      {"braveLeoAssistantCustomizationEnabledLabel", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_ENABLED_LABEL},
      {"braveLeoAssistantCustomizationEnabledDescription", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_ENABLED_DESCRIPTION},
      {"braveLeoAssistantUserMemoryEnabledLabel", IDS_SETTINGS_LEO_ASSISTANT_USER_MEMORY_ENABLED_LABEL},
      {"braveLeoAssistantUserMemoryEnabledDescription", IDS_SETTINGS_LEO_ASSISTANT_USER_MEMORY_ENABLED_DESCRIPTION},
      {"braveLeoAssistantCustomizationNameLabel", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_NAME_LABEL},
      {"braveLeoAssistantCustomizationNamePlaceholder", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_NAME_PLACEHOLDER},
      {"braveLeoAssistantCustomizationJobLabel", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_JOB_LABEL},
      {"braveLeoAssistantCustomizationJobPlaceholder", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_JOB_PLACEHOLDER},
      {"braveLeoAssistantCustomizationToneLabel", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_TONE_LABEL},
      {"braveLeoAssistantCustomizationTonePlaceholder", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_TONE_PLACEHOLDER},
      {"braveLeoAssistantCustomizationOtherLabel", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_OTHER_LABEL},
      {"braveLeoAssistantCustomizationOtherPlaceholder", IDS_SETTINGS_LEO_ASSISTANT_CUSTOMIZATION_OTHER_PLACEHOLDER},
      ...
      {"braveLeoAssistantMemoryListEmptyTitle", IDS_SETTINGS_LEO_ASSISTANT_MEMORY_LIST_EMPTY_TITLE},
      {"braveLeoAssistantMemoryListEmptyDescription", IDS_SETTINGS_LEO_ASSISTANT_MEMORY_LIST_EMPTY_DESCRIPTION},
